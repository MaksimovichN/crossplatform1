...
namespace Maksimovich.Models
{
    ...
    {
        public static string Issuer => "Maksimovich";
        public static string Audience => "APIclients";
        public static int LifetimeInYears => 1;
        public static SecurityKey SigningKey => new SymmetricSecurityKey(Encoding.ASCII.GetBytes("maksskiriiiiiiiiiiii124paupaupau"));
